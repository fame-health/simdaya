                        ...
                        <div style="background: linear-gradient(135deg, #e0f2fe 0%, #bfdbfe 100%);
                            ...
                            <div style="display: flex; align-items: center; margin-bottom: 12px;">
                                ...
                                <h3 style="color: #1e40af;
                                          font-size: 20px;
                                          font-weight: 700;
                                          margin: 0;">ISI SAMPAI MINGGU KE: ' . htmlspecialchars($pengajuan->durasi_magang) . '</h3>
                            </div>
                            <div style="background: #bfdbfe;
                                ...
                                <p style="color: #1e40af;
                                         ...
                                         margin: 0;
                                         line-height: 1.5;">
                                    Anda harus mengisi laporan mingguan sampai minggu ke-' . htmlspecialchars($pengajuan->durasi_magang) . ' sesuai durasi magang yang disetujui.
                                </p>
                            </div>
                        </div>
                    ');
                        ...
                        <div style="background: linear-gradient(135deg, #fef3c7 0%, #fed7aa 100%);
                            ...
                            <div style="display: flex; align-items: center; margin-bottom: 12px;">
                                ...
                                <h3 style="color: #92400e;
                                          font-size: 22px;
                                          font-weight: 700;
                                          margin: 0;">LAPORAN MINGGUAN (' . htmlspecialchars($pendingCount) . ' PENDING)</h3>
                            </div>
                            <div style="background: #fed7aa;
                                ...
                                <p style="color: #92400e;
                                         ...
                                         margin: 0;
                                         line-height: 1.5;">
                                    Tinjau dan setujui laporan mingguan dari mahasiswa yang Anda bimbing. Gunakan tombol di bawah untuk memfilter laporan berdasarkan nama mahasiswa.
                                </p>
                            </div>
                            <div style="margin-top: 16px;">
                                <button type="button"
                                        ...
                                        title="Filter laporan berdasarkan nama mahasiswa"
                                        onclick="document.querySelector(\'[wire\\\\:model=\\\"tableFilters.mahasiswa_id.value\\\"]\').focus();">
